        ...
        child: Column(
          children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text('Shop the latest products', style: TextStyle(fontSize: 16, color: Colors.white)),
                      ],
                    ),
                  ),
                ],
            ...
            Container(
              ...
              child: const Text('Produk Kami', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
            ),
